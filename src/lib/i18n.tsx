...
export const dict = {
  fa: {
    ...
    copilot: {
      ...
      title: 'از عملیات خود سؤالی بپرسید.',
    ...
    enterprise: {
      ...
      ctaTitle: 'آن را روی ',
      ctaTitleAccent: 'خط مقدم کسب‌وکار خود ',
    ...
    contact: {
      ...
      desc: 'آماده‌اید عملیات خود را به یک لایهٔ هوشمند متصل کنید؟ تیم ما در یک روز کاری پاسخ می‌دهد. جلسهٔ دمو رایگان است.',
